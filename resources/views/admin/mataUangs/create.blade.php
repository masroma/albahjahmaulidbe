...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.mataUang.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.mata-uangs.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mata_uang') ? 'is-invalid' : '' }}" type="text" name="mata_uang" id="mata_uang" value="{{ old('mata_uang', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('simbol') ? 'is-invalid' : '' }}" type="text" name="simbol" id="simbol" value="{{ old('simbol', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kurs') ? 'is-invalid' : '' }}" type="text" name="kurs" id="kurs" value="{{ old('kurs', '1') }}">
                @if($errors->has('kurs'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fiskal') ? 'is-invalid' : '' }}" type="text" name="fiskal" id="fiskal" value="{{ old('fiskal', '1') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('rate_type') ? 'is-invalid' : '' }}" name="rate_type" id="rate_type">
                    ...
                    @foreach(App\Models\MataUang::RATE_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('rate_type', 'N') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
