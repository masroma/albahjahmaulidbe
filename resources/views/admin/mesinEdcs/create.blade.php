...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.mesinEdc.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.mesin-edcs.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="kode_edc">{{ trans('cruds.mesinEdc.fields.kode_edc') }}</label>
                <input class="form-control {{ $errors->has('kode_edc') ? 'is-invalid' : '' }}" type="text" name="kode_edc" id="kode_edc" value="{{ old('kode_edc', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_edc') ? 'is-invalid' : '' }}" type="text" name="nama_edc" id="nama_edc" value="{{ old('nama_edc', '') }}" required>
