...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.grupMitraBisnisTwo.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.grup-mitra-bisnis-twos.store") }}" enctype="multipart/form-data">
            @csrf
