    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-itemAkunReturnPenjualanItems">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($items as $key => $item)
                            <tr data-entry-id="{{ $item->id }}">
                                ...
                                <td>
                                    <span style="display:none">{{ $item->item_akun_aktif ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-itemAkunReturnPenjualanItems:not(.ajaxTable)').DataTable({ buttons: dtButtons })
