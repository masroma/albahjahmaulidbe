...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.tipeKartuKredit.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tipe-kartu-kredits.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_kartu_kredit') ? 'is-invalid' : '' }}" type="text" name="nama_kartu_kredit" id="nama_kartu_kredit" value="{{ old('nama_kartu_kredit', '') }}" required>
