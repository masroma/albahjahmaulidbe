...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.penagih.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.penagihs.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_penagih') ? 'is-invalid' : '' }}" type="text" name="nama_penagih" id="nama_penagih" value="{{ old('nama_penagih', '') }}" required>
