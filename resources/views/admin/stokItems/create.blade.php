...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.stokItem.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.stok-items.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qty') ? 'is-invalid' : '' }}" type="text" name="qty" id="qty" value="{{ old('qty', '0') }}">
                @if($errors->has('qty'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pid') ? 'is-invalid' : '' }}" type="text" name="pid" id="pid" value="{{ old('pid', '') }}">
                @if($errors->has('pid'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hpp') ? 'is-invalid' : '' }}" type="text" name="hpp" id="hpp" value="{{ old('hpp', '0') }}">
                @if($errors->has('hpp'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min') ? 'is-invalid' : '' }}" type="text" name="min" id="min" value="{{ old('min', '0') }}">
                @if($errors->has('min'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max') ? 'is-invalid' : '' }}" type="text" name="max" id="max" value="{{ old('max', '0') }}">
                @if($errors->has('max'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('re_order') ? 'is-invalid' : '' }}" type="text" name="re_order" id="re_order" value="{{ old('re_order', '0') }}">
