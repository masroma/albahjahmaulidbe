...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.hutangPiutangMitraBisni.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.hutang-piutang-mitra-bisnis.update", [$hutangPiutangMitraBisni->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('mitra_bisnis') ? 'is-invalid' : '' }}" name="mitra_bisnis[]" id="mitra_bisnis" multiple>
                    @foreach($mitra_bisnis as $id => $mitra_bisni)
                        <option value="{{ $id }}" {{ (in_array($id, old('mitra_bisnis', [])) || $hutangPiutangMitraBisni->mitra_bisnis->contains($id)) ? 'selected' : '' }}>{{ $mitra_bisni }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('mata_uangs') ? 'is-invalid' : '' }}" name="mata_uangs[]" id="mata_uangs" multiple>
                    @foreach($mata_uangs as $id => $mata_uang)
                        <option value="{{ $id }}" {{ (in_array($id, old('mata_uangs', [])) || $hutangPiutangMitraBisni->mata_uangs->contains($id)) ? 'selected' : '' }}>{{ $mata_uang }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('pembelian_termin') ? 'is-invalid' : '' }}" name="pembelian_termin" id="pembelian_termin">
                    ...
                    @foreach(App\Models\HutangPiutangMitraBisni::PEMBELIAN_TERMIN_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('pembelian_termin', $hutangPiutangMitraBisni->pembelian_termin) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pembelian_tempo') ? 'is-invalid' : '' }}" type="text" name="pembelian_tempo" id="pembelian_tempo" value="{{ old('pembelian_tempo', $hutangPiutangMitraBisni->pembelian_tempo) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('penjualan_termin') ? 'is-invalid' : '' }}" name="penjualan_termin" id="penjualan_termin">
                    ...
                    @foreach(App\Models\HutangPiutangMitraBisni::PENJUALAN_TERMIN_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('penjualan_termin', $hutangPiutangMitraBisni->penjualan_termin) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('penjualan_tempo') ? 'is-invalid' : '' }}" type="text" name="penjualan_tempo" id="penjualan_tempo" value="{{ old('penjualan_tempo', $hutangPiutangMitraBisni->penjualan_tempo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('batas_hutang') ? 'is-invalid' : '' }}" type="text" name="batas_hutang" id="batas_hutang" value="{{ old('batas_hutang', $hutangPiutangMitraBisni->batas_hutang) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('batas_frekuensi_hutang') ? 'is-invalid' : '' }}" type="text" name="batas_frekuensi_hutang" id="batas_frekuensi_hutang" value="{{ old('batas_frekuensi_hutang', $hutangPiutangMitraBisni->batas_frekuensi_hutang) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('akun_hutangs') ? 'is-invalid' : '' }}" name="akun_hutangs[]" id="akun_hutangs" multiple>
                    @foreach($akun_hutangs as $id => $akun_hutang)
                        <option value="{{ $id }}" {{ (in_array($id, old('akun_hutangs', [])) || $hutangPiutangMitraBisni->akun_hutangs->contains($id)) ? 'selected' : '' }}>{{ $akun_hutang }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('batas_piutang') ? 'is-invalid' : '' }}" type="text" name="batas_piutang" id="batas_piutang" value="{{ old('batas_piutang', $hutangPiutangMitraBisni->batas_piutang) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('batas_frekuensi_piutang') ? 'is-invalid' : '' }}" type="text" name="batas_frekuensi_piutang" id="batas_frekuensi_piutang" value="{{ old('batas_frekuensi_piutang', $hutangPiutangMitraBisni->batas_frekuensi_piutang) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('akun_stakeholder_piutangs') ? 'is-invalid' : '' }}" name="akun_stakeholder_piutangs[]" id="akun_stakeholder_piutangs" multiple>
                    @foreach($akun_stakeholder_piutangs as $id => $akun_stakeholder_piutang)
                        <option value="{{ $id }}" {{ (in_array($id, old('akun_stakeholder_piutangs', [])) || $hutangPiutangMitraBisni->akun_stakeholder_piutangs->contains($id)) ? 'selected' : '' }}>{{ $akun_stakeholder_piutang }}</option>
                    @endforeach
                </select>
