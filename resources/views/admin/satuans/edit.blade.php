...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.satuan.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.satuans.update", [$satuan->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="satuan_1">{{ trans('cruds.satuan.fields.satuan_1') }}</label>
                <input class="form-control {{ $errors->has('satuan_1') ? 'is-invalid' : '' }}" type="text" name="satuan_1" id="satuan_1" value="{{ old('satuan_1', $satuan->satuan_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('satuan_2') ? 'is-invalid' : '' }}" type="text" name="satuan_2" id="satuan_2" value="{{ old('satuan_2', $satuan->satuan_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('isi_2') ? 'is-invalid' : '' }}" type="text" name="isi_2" id="isi_2" value="{{ old('isi_2', $satuan->isi_2) }}">
                @if($errors->has('isi_2'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('satuan_3') ? 'is-invalid' : '' }}" type="text" name="satuan_3" id="satuan_3" value="{{ old('satuan_3', $satuan->satuan_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('isi_3') ? 'is-invalid' : '' }}" type="text" name="isi_3" id="isi_3" value="{{ old('isi_3', $satuan->isi_3) }}">
                @if($errors->has('isi_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('satuan_pembelian') ? 'is-invalid' : '' }}" type="text" name="satuan_pembelian" id="satuan_pembelian" value="{{ old('satuan_pembelian', $satuan->satuan_pembelian) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('satuan_penjualan') ? 'is-invalid' : '' }}" type="text" name="satuan_penjualan" id="satuan_penjualan" value="{{ old('satuan_penjualan', $satuan->satuan_penjualan) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('satuan_stok') ? 'is-invalid' : '' }}" type="text" name="satuan_stok" id="satuan_stok" value="{{ old('satuan_stok', $satuan->satuan_stok) }}">
