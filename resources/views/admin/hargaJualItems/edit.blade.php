...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.hargaJualItem.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.harga-jual-items.update", [$hargaJualItem->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('item') ? 'is-invalid' : '' }}" name="item_id" id="item_id" required>
                    @foreach($items as $id => $entry)
                        <option value="{{ $id }}" {{ (old('item_id') ? old('item_id') : $hargaJualItem->item->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('item'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('level_harga') ? 'is-invalid' : '' }}" name="level_harga_id" id="level_harga_id" required>
                    @foreach($level_hargas as $id => $entry)
                        <option value="{{ $id }}" {{ (old('level_harga_id') ? old('level_harga_id') : $hargaJualItem->level_harga->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('mata_uang') ? 'is-invalid' : '' }}" name="mata_uang_id" id="mata_uang_id" required>
                    @foreach($mata_uangs as $id => $entry)
                        <option value="{{ $id }}" {{ (old('mata_uang_id') ? old('mata_uang_id') : $hargaJualItem->mata_uang->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('harga_satuan_1') ? 'is-invalid' : '' }}" type="text" name="harga_satuan_1" id="harga_satuan_1" value="{{ old('harga_satuan_1', $hargaJualItem->harga_satuan_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('diskon_satuan_1') ? 'is-invalid' : '' }}" type="text" name="diskon_satuan_1" id="diskon_satuan_1" value="{{ old('diskon_satuan_1', $hargaJualItem->diskon_satuan_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('harga_satuan_2') ? 'is-invalid' : '' }}" type="text" name="harga_satuan_2" id="harga_satuan_2" value="{{ old('harga_satuan_2', $hargaJualItem->harga_satuan_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('diskon_satuan_2') ? 'is-invalid' : '' }}" type="text" name="diskon_satuan_2" id="diskon_satuan_2" value="{{ old('diskon_satuan_2', $hargaJualItem->diskon_satuan_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('harga_satuan_3') ? 'is-invalid' : '' }}" type="text" name="harga_satuan_3" id="harga_satuan_3" value="{{ old('harga_satuan_3', $hargaJualItem->harga_satuan_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('diskon_satuan_3') ? 'is-invalid' : '' }}" type="text" name="diskon_satuan_3" id="diskon_satuan_3" value="{{ old('diskon_satuan_3', $hargaJualItem->diskon_satuan_3) }}">
