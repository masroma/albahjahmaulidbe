            ...
            <thead>
                ...
                <tr>
                    ...
                    <td>
                        <select class="search">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach($item_group_ones as $key => $item)
                                <option value="{{ $item->nama }}">{{ $item->nama }}</option>
                            @endforeach
                        </select>
                    </td>
...
{ data: 'item_kode', name: 'item_kode' },
{ data: 'item_nama', name: 'item_nama' },
{ data: 'barcode', name: 'barcode' },
{ data: 'item_merk_nama', name: 'item_merk.nama' },
{ data: 'item_group_one_nama', name: 'item_group_one.nama' },
{ data: 'item_akun_aktif', name: 'item_akun_aktif' },
