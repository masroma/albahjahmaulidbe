    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.items.update", [$item->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('item_kode') ? 'is-invalid' : '' }}" type="text" name="item_kode" id="item_kode" value="{{ old('item_kode', $item->item_kode) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('item_nama') ? 'is-invalid' : '' }}" type="text" name="item_nama" id="item_nama" value="{{ old('item_nama', $item->item_nama) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('item_merk') ? 'is-invalid' : '' }}" name="item_merk_id" id="item_merk_id">
                    @foreach($item_merks as $id => $entry)
                        <option value="{{ $id }}" {{ (old('item_merk_id') ? old('item_merk_id') : $item->item_merk->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('item_group_one') ? 'is-invalid' : '' }}" name="item_group_one_id" id="item_group_one_id">
                    @foreach($item_group_ones as $id => $entry)
                        <option value="{{ $id }}" {{ (old('item_group_one_id') ? old('item_group_one_id') : $item->item_group_one->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('item_akun_aktif') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="item_akun_aktif" id="item_akun_aktif" value="1" {{ $item->item_akun_aktif || old('item_akun_aktif', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('item_alias_nama') ? 'is-invalid' : '' }}" type="text" name="item_alias_nama" id="item_alias_nama" value="{{ old('item_alias_nama', $item->item_alias_nama) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('item_group_two') ? 'is-invalid' : '' }}" name="item_group_two_id" id="item_group_two_id">
                    @foreach($item_group_twos as $id => $entry)
                        <option value="{{ $id }}" {{ (old('item_group_two_id') ? old('item_group_two_id') : $item->item_group_two->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('item_group_three') ? 'is-invalid' : '' }}" name="item_group_three_id" id="item_group_three_id">
                    @foreach($item_group_threes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('item_group_three_id') ? old('item_group_three_id') : $item->item_group_three->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('item_satuan_one') ? 'is-invalid' : '' }}" type="number" name="item_satuan_one" id="item_satuan_one" value="{{ old('item_satuan_one', $item->item_satuan_one) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('item_satuan_two') ? 'is-invalid' : '' }}" type="number" name="item_satuan_two" id="item_satuan_two" value="{{ old('item_satuan_two', $item->item_satuan_two) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('item_satuan_three') ? 'is-invalid' : '' }}" type="number" name="item_satuan_three" id="item_satuan_three" value="{{ old('item_satuan_three', $item->item_satuan_three) }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('item_akun_pembelian') ? 'is-invalid' : '' }}" name="item_akun_pembelian_id" id="item_akun_pembelian_id">
                    @foreach($item_akun_pembelians as $id => $entry)
                        <option value="{{ $id }}" {{ (old('item_akun_pembelian_id') ? old('item_akun_pembelian_id') : $item->item_akun_pembelian->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('item_akun_hpp') ? 'is-invalid' : '' }}" name="item_akun_hpp_id" id="item_akun_hpp_id">
                    @foreach($item_akun_hpps as $id => $entry)
                        <option value="{{ $id }}" {{ (old('item_akun_hpp_id') ? old('item_akun_hpp_id') : $item->item_akun_hpp->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('item_akun_penjualan') ? 'is-invalid' : '' }}" name="item_akun_penjualan_id" id="item_akun_penjualan_id">
                    @foreach($item_akun_penjualans as $id => $entry)
                        <option value="{{ $id }}" {{ (old('item_akun_penjualan_id') ? old('item_akun_penjualan_id') : $item->item_akun_penjualan->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('item_akun_return_penjualan') ? 'is-invalid' : '' }}" name="item_akun_return_penjualan_id" id="item_akun_return_penjualan_id">
                    @foreach($item_akun_return_penjualans as $id => $entry)
                        <option value="{{ $id }}" {{ (old('item_akun_return_penjualan_id') ? old('item_akun_return_penjualan_id') : $item->item_akun_return_penjualan->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('satuans') ? 'is-invalid' : '' }}" name="satuans[]" id="satuans" multiple>
                    @foreach($satuans as $id => $satuan)
                        <option value="{{ $id }}" {{ (in_array($id, old('satuans', [])) || $item->satuans->contains($id)) ? 'selected' : '' }}>{{ $satuan }}</option>
                    @endforeach
                </select>
