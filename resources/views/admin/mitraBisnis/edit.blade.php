...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.mitraBisni.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.mitra-bisnis.update", [$mitraBisni->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="kode">{{ trans('cruds.mitraBisni.fields.kode') }}</label>
                <input class="form-control {{ $errors->has('kode') ? 'is-invalid' : '' }}" type="text" name="kode" id="kode" value="{{ old('kode', $mitraBisni->kode) }}" required>
                @if($errors->has('kode'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}" type="text" name="nama" id="nama" value="{{ old('nama', $mitraBisni->nama) }}" required>
                @if($errors->has('nama'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('deskripsi') ? 'is-invalid' : '' }}" name="deskripsi" id="deskripsi">{{ old('deskripsi', $mitraBisni->deskripsi) }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('aktif') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="aktif" id="aktif" value="1" {{ $mitraBisni->aktif || old('aktif', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('tipe_bisnis_customer') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="tipe_bisnis_customer" id="tipe_bisnis_customer" value="1" {{ $mitraBisni->tipe_bisnis_customer || old('tipe_bisnis_customer', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('tipe_bisnis_supplier') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="tipe_bisnis_supplier" id="tipe_bisnis_supplier" value="1" {{ $mitraBisni->tipe_bisnis_supplier || old('tipe_bisnis_supplier', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('group_1s') ? 'is-invalid' : '' }}" name="group_1s[]" id="group_1s" multiple>
                    @foreach($group_1s as $id => $group_1)
                        <option value="{{ $id }}" {{ (in_array($id, old('group_1s', [])) || $mitraBisni->group_1s->contains($id)) ? 'selected' : '' }}>{{ $group_1 }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('group_2s') ? 'is-invalid' : '' }}" name="group_2s[]" id="group_2s" multiple>
                    @foreach($group_2s as $id => $group_2)
                        <option value="{{ $id }}" {{ (in_array($id, old('group_2s', [])) || $mitraBisni->group_2s->contains($id)) ? 'selected' : '' }}>{{ $group_2 }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('group_3s') ? 'is-invalid' : '' }}" name="group_3s[]" id="group_3s" multiple>
                    @foreach($group_3s as $id => $group_3)
                        <option value="{{ $id }}" {{ (in_array($id, old('group_3s', [])) || $mitraBisni->group_3s->contains($id)) ? 'selected' : '' }}>{{ $group_3 }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('level_hargas') ? 'is-invalid' : '' }}" name="level_hargas[]" id="level_hargas" multiple>
                    @foreach($level_hargas as $id => $level_harga)
                        <option value="{{ $id }}" {{ (in_array($id, old('level_hargas', [])) || $mitraBisni->level_hargas->contains($id)) ? 'selected' : '' }}>{{ $level_harga }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('sales') ? 'is-invalid' : '' }}" name="sales[]" id="sales" multiple>
                    @foreach($sales as $id => $sale)
                        <option value="{{ $id }}" {{ (in_array($id, old('sales', [])) || $mitraBisni->sales->contains($id)) ? 'selected' : '' }}>{{ $sale }}</option>
                    @endforeach
                </select>
                @if($errors->has('sales'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bank') ? 'is-invalid' : '' }}" type="text" name="bank" id="bank" value="{{ old('bank', $mitraBisni->bank) }}">
                @if($errors->has('bank'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_rekening') ? 'is-invalid' : '' }}" type="text" name="no_rekening" id="no_rekening" value="{{ old('no_rekening', $mitraBisni->no_rekening) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('atas_nama') ? 'is-invalid' : '' }}" type="text" name="atas_nama" id="atas_nama" value="{{ old('atas_nama', $mitraBisni->atas_nama) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('npwp') ? 'is-invalid' : '' }}" type="text" name="npwp" id="npwp" value="{{ old('npwp', $mitraBisni->npwp) }}">
                @if($errors->has('npwp'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pkp') ? 'is-invalid' : '' }}" type="text" name="pkp" id="pkp" value="{{ old('pkp', $mitraBisni->pkp) }}">
                @if($errors->has('pkp'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tanggal_pkp') ? 'is-invalid' : '' }}" type="text" name="tanggal_pkp" id="tanggal_pkp" value="{{ old('tanggal_pkp', $mitraBisni->tanggal_pkp) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_nik') ? 'is-invalid' : '' }}" type="text" name="no_nik" id="no_nik" value="{{ old('no_nik', $mitraBisni->no_nik) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('atas_nama_nik') ? 'is-invalid' : '' }}" type="text" name="atas_nama_nik" id="atas_nama_nik" value="{{ old('atas_nama_nik', $mitraBisni->atas_nama_nik) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('pembelian_pajak') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="pembelian_pajak" id="pembelian_pajak" value="1" {{ $mitraBisni->pembelian_pajak || old('pembelian_pajak', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('penjualan_pajak') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="penjualan_pajak" id="penjualan_pajak" value="1" {{ $mitraBisni->penjualan_pajak || old('penjualan_pajak', 0) === 1 ? 'checked' : '' }}>
